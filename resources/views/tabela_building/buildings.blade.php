<x-app-layout>
    ...
    <div class="flex justify-center mt-8">
        <a href="{{ route('buildings.create') }}"
            class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-400 transition duration-300">
            Criar
        </a>
    </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <h3
                    class="p-6 text-lg font-semibold text-center text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    Predio
                </h3>
